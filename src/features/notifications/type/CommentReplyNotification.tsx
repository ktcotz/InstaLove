...
type CommentReplyNotificationsProps = {
  created_at?: string;
  user?: Profile;
  post_id: number | null;
  receiver?: Profile;
...
export const CommentReplyNotifications = ({
  created_at,
  user,
  receiver,
  post_id,
}: CommentReplyNotificationsProps) => {
  ...
  return (
    ...
    >
      ...
      <div className="text-xs">
        ...
        <p className="text-stone-900">odpowiedział na twój komentarz</p>
